...
public class ConfigurationBean {
	...
	/** The MESSAGING_PORT with value hiperium.message.host. */
	public static final String MESSAGING_PORT = "hiperium.messaging.port";
	...
	@PersistenceContext(unitName = "hiperiumControlPU")
	...
	public void init() {
		...
		this.cluster = Cluster.builder().addContactPoint(PROPERTIES.getProperty(CASSANDRA_HOST))
				.withPort(Integer.parseInt(PROPERTIES.getProperty(CASSANDRA_PORT))).build();
